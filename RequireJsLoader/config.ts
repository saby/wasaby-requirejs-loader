    ...
    (() => {
                ...
                if (url) {
                    return (
                        ...
                        this.MODULES.some((mod) => {
                            if (url.indexOf(this.RESOURCE_ROOT + mod) !== -1) {
                                return true;
                            }
        ...
        function buildHandlers(config: IWsConfig): IHandlersInternal {
            ...
            function isExcludedUrl(url: string) {
                // don't add cdn domains only for root urls without interface module.
                ...
                return url.indexOf('.svg') !== -1 || url.indexOf('manifest.json') !== -1;
            }
        ...
        function createConfig(
            ...
            const config: RequireConfig = {
                ...
                paths: {
                    ...
                    // pixi libraries
                    pixi: `${cdnRoot}PixiJS/6.5.10-p3/pixi.min`,
                    'pixi-react': `${cdnRoot}PixiReact/6.8.0-p1/pixi-react.min`,
