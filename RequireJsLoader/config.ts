...
interface IHandlersInternal {
    ...
    getWithVersion(url?: string): string | undefined;
...
interface IStaticFile {
    prevConfig?: RequireJsLoader.IStaticResourcesConfig;
    prevStaticDomains?: RequireJsLoader.IStaticResourcesConfig | string[];
    ...
    (() => {
        ...
        function createResourceLoader(
            ...
            return function onResourceLoad(
                ...
                if (!map.prefix) {
                    let exports: Record<string, unknown> | Function | RequireJsLoader.ITensorFunction = context.defined[
                        map.id
                        ...
                        if (typeof exports === 'function') {
                            ...
                            if (proto) {
                                ...
                                if (!exports.hasOwnProperty('_moduleName')) {
                                    (exports as RequireJsLoader.ITensorFunction)._moduleName = map.name;
                                    (exports as RequireJsLoader.ITensorFunction)._isPrivateModule = isPrivateModule || undefined;
                                }
                            }
                        } else if (
                            ...
                            Object.keys(exports).forEach((name) => {
                                ...
                                if (typeof module === 'function') {
                                    ...
                                    if (proto) {
                                        ...
                                        if ((module as RequireJsLoader.ITensorFunction)._isPrivateModule ||
                                            !module.hasOwnProperty('_moduleName')) {
                                            (module as RequireJsLoader.ITensorFunction)._moduleName = map.name + ':' + name;
                                        }
                                    }
                                }
                            });
        ...
        // returns array of debugging modules by transmitted cookie
        function getDebugModules(cookie: string): string[] {
            ...
            if (debugModules.length > 0) {
                ...
                if (debugModules.includes('WS.Core')) {
        ...
        function createLoader() {
            ...
            function processModule(name: string, plugin: string, defaultLoad: () => void) {
                ...
                if (moduleInfo.hasOwnProperty('hasBundles')) {
                    ...
                    requirejs([`json!${moduleName}/contents`], (currentContents: RequireJsLoader.IContents) => {
                        if (currentContents?.modules?.[moduleName].hasOwnProperty('hasBundles')) {
                            requirejs([`${moduleName}/packageMap.json`], (bundles: Record<string, string>) => {
                                bundlesMap[moduleName] = bundles;
                                loadModule(
                                    moduleName,
                                    name,
