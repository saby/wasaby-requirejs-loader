...
define('RequireJsLoader/config', (() => {
    ...
    const BUILD_MODE: RequireJsLoader.BuildMode = globalThis.contents?.buildMode || DEBUG_MODE;

    // server-side react mode. release by default
    const REACT_MODE: RequireJsLoader.BuildMode = globalThis.contents?.modules.React?.mode || RELEASE_MODE;
