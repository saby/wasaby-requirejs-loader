        ...
        function buildHandlers(config: IWsConfig): IHandlersInternal {
            ...
            function getWithVersion(url: string, version?: boolean): string {
                if (typeof url === 'string') {
                    ...
                    if (
                        wsConfig.cdnRoot &&
                        url.startsWith(DEFAULT_CDN_PATH) &&
        ...
        function createConfig(
            ...
            const config: RequireConfig = {
                ...
                paths: {
                    ...
                    // pixi libraries
                    pixi: '/cdn/PixiJS/6.5.10-p2/pixi.min',
                    'pixi-react': '/cdn/PixiReact/6.8.0-p1/pixi-react.min',

                    // jQuery must die
                    jquery: `${DEFAULT_CDN_PATH}JQuery/jquery/3.3.1/jquery-min`,
                },
                onNodeCreated,
