...
define(
    ...
    (() => {
            ...
            return function onResourceLoad(
                ...
                if (!map.prefix) {
                    let exports:
                        ...
                        | Function
                        | RequireJsLoader.ITensorFunction = context.defined[map.id] as Record<
                        string,
                        unknown
                    >;
                        ...
                        if (typeof exports === 'function') {
                            ...
                            if (proto) {
                                ...
                                if (!exports.hasOwnProperty('_moduleName')) {
                                    const arrowFunction =
                                        exports as RequireJsLoader.ITensorFunction;
                            ...
                            Object.keys(exports).forEach((name) => {
                                ...
                                if (typeof module === 'function') {
                                    ...
                                    if (proto) {
                                        ...
                                        if (
                                            (module as RequireJsLoader.ITensorFunction)
                                                ._isPrivateModule ||
                                            !module.hasOwnProperty('_moduleName')
                                        ) {
                                            (
                                                module as RequireJsLoader.ITensorFunction
                                            )._moduleName = map.name + ':' + name;
                                        }
                                    }
                                }
                            });
        ...
        function buildHandlers(config: RequireJsLoader.IWsConfig): IHandlersInternal {
            ...
            function getVersions(url: string, version?: boolean):
                | {
                      context: string;
                      defined: boolean;
                      module: string;
