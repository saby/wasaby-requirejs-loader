...
function onErrorRequire(element: HTMLScriptElement, showAlert: boolean = false) {
    if (showAlert) {
        const confirmed = confirm(
            `Возникла ошибка загрузки базового ресурса.\n\n Попробуйте перезагрузить страницу вручную или нажмите «ОК» для автоматической перезагрузки.`
        );
...
globalThis.callbacksForResourcesBlock = new Map();
