define('is-api', function () {
   ...
   api.parse = function (f) {
      ...
      var noModuleId = actions.substr(
         yesModuleId.length + 1,
         actions.length - yesModuleId.length - 1
      );
      ...
      if (
         yesModuleId &&
         yesModuleId.substr(0, 1) === '[' &&
         yesModuleId.substr(yesModuleId.length - 1, 1) === ']'
      ) {
      ...
      if (
         noModuleId &&
         noModuleId.substr(0, 1) === '[' &&
         noModuleId.substr(noModuleId.length - 1, 1) === ']'
      ) {
