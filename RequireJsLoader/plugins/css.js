define('css', [
   ...
   var loadCss = (globalThis.wsConfig || {}).loadCss === undefined ? true : globalThis.wsConfig.loadCss;
   ...
   function loadStyle(name, require, load, conf) {
       ...
       if (name.indexOf('theme?') !== -1) {
           ...
           tc.get(name.replace('theme?', ''), globalThis.themeName, controller.THEME_TYPE.SINGLE).then(onload, onerror);
           return;
       }
