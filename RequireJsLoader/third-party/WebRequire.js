...
(function () {
    ...
    class WebRequire extends BaseRequire {
        ...
        buildConfig({ modules, pagexPackages, rootDomain, staticsRoot = '/resources/', metaRoot = '', cdnRoot = '/cdn/', contents, }) {
            ...
            for (const [name, moduleConfig] of Object.entries(modules)) {
                ...
                const info = {
                    buildUrl(filePath, extension) {
                        ...
                        if (extension === 'css' && ((_a = document.body) === null || _a === void 0 ? void 0 : _a.dir) === 'rtl') {
                            return `${domain}${root}${filePath}${postfixForMinVersion}.rtl.${extension}${queryParams}`;
                        }
