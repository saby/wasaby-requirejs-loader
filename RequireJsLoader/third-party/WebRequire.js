  ...
  `;
    ...
    class Loader {
        constructor(timeout) {
            ...
            window.removeEventListener('error', globalEnv$1.onErrorHandler, true);
                ...
                if (filename && error) {
                    ...
                    if (!loadingUrls.has(url)) {
                        ...
                        if (event.target.onload) {
                            loadPromise.then(() => {
                                globalEnv$1.onloadScript?.(event.target);
                            });
                        }
    ...
    class WebRequire extends BaseRequire {
        constructor() {
            ...
            this.currentNumberDomain = Number(document.cookie.match(/(?:^|;)\s*res_loader_cdn_idx\s*=\s*([^;]+)/)?.[1] || 0);
