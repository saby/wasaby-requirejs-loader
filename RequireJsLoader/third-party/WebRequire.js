...
(function () {
    ...
    class FileInfo {
        ...
        static isFileInfo(value) {
            return (value === null || value === void 0 ? void 0 : value[isFileInfo]) === true;
        }
    }
        ...
        extractChain(module, fileInfo) {
            ...
            if (chain && chain.length !== 0) {
                ...
                for (const nameProp of chain) {
                    ...
                    throw new RequireError(`Chain access failed at '${nameProp}' for module ${fileInfo.defineName}:${chain.join('.')};`, {
                        type: 'ChainError',
                    });
                }
                return result;
    ...
    class ModuleInfo {
        constructor() {
            ...
            this.buildPath = function (res, extension) {
    ...
    async function html (module, { buildUrl, crossOrigin }, context) {
        ...
        await context.require(['i18n!' + module.path.split('/')[0]]);
        const html = await fetchLoader(module.url, crossOrigin);
    ...
    function callLoader(packagesInfo, module, moduleInfo, context, defaultLoader) {
        if (packagesInfo.map.hasOwnProperty(module.name)) {
            ...
            module.path = packagePath.replace(regExpExt, '');
    ...
    function hasPackages(moduleInfo) {
        var _a;
        return moduleInfo.hasOwnProperty('packagesInfo') && !!((_a = moduleInfo.packagesInfo) === null || _a === void 0 ? void 0 : _a.mapPath);
    }
    /**
    ...
    class WebRequire extends BaseRequire {
        ...
        buildConfig({ modules, rootDomain, staticsRoot = '/resources/', metaRoot = '', cdnRoot = '/cdn/', contents, }) {
            ...
            const { extensionForTemplate: templateExtension = '', buildnumber: defaultVersion = '99.9999-1', ESVersion: defaultESVersions = 0, } = contents;
            for (const [name, moduleConfig] of Object.entries(modules)) {
                const { hasBundles, 
                // eslint-disable-next-line @typescript-eslint/naming-convention
                from_ps, buildnumber, path, hasTailwind = false, ESVersion, } = moduleConfig;
                ...
                info.buildUrl = (filePath, extension) => {
                    var _a;
                    if (extension === 'svg') {
            ...
            cdnInfo.buildUrl = (moduleName, extension) => {
            ...
            defaultInfo.buildUrl = (filePath, extension) => {
        ...
        async processModule(fullName, fileInfo) {
            ...
            try {
                ...
                return this.extractChain(exports, fileInfo);
            }
            catch (err) {
                throw err;
            }
