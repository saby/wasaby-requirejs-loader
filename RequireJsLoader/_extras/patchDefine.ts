 ...
 */
const needCheckCircularDependencies = globalThis.wsConfig && Boolean(
    globalThis.wsConfig.IS_OVERALL_DEBUG ||
    (globalThis.wsConfig.DEBUGGING_MODULES && globalThis.wsConfig.DEBUGGING_MODULES.length)
);
...
export default function patchDefine(): () => void {
    ...
    if (globalThis.define) {
        ...
        globalThis.define = getPatchedDefine(globalThis.requirejs, globalThis.define, globalThis.contents);
    }
