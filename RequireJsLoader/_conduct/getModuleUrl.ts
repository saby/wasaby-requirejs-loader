 ...
 * @param {boolean} version параметр, определяющий, нужно ли вставлять заголовок версионирования
...
export default function getModuleUrl(
    ...
    return getResourceUrl(url, debugCookieValue, skipDomains, isIE, direction, version);
}
