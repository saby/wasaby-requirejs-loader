import { IRequireContext, IRequireExt, IRequireMapExt } from '../requireTypes';
    ...
    implements IModulesManager, IModulesManagerSync, IModulesHandler
{
    ...
    unloadSync(module: string): void {
        ...
        if ((this._loader as IRequireExt).isNewRequire) {
            this._loader.undef(module);
    ...
    static isModule(name: string): boolean {
        if (globalEnv.contents && globalEnv.contents.modules) {
            ...
            if (moduleNameMatch) {
                ...
                return (
                    globalEnv.contents.modules.hasOwnProperty(moduleName) ||
