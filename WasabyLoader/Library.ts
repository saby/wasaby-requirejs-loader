 ...
 * @param exports Имплементация библиотеки.
 * @param info Информация об извлекаемом экспорте.
 ...
 * @param name Имя модуля. Например 'Library/Name:Path.To.Module' или 'Module/Name'.
 * @return Описание экспорта библиотеки.
 * @public
 */
