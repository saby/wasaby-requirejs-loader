 ...
 * @param {String} name Имя модуля в обычном (Foo/bar) или библиотечном (Foo/bar:baz) синтаксисе
 * @param {Function} [callback] Колбек на успех, возврашает загруженный модуль.
 * @param {Function} [errback] Колбек на ошибку, возврашает ошибку.
 */
